      ...
      <Container>
            ...
            <View style={{ flexDirection: 'row', paddingLeft: scale(20), paddingVertical: verticalScale(20), paddingHorizontal: scale(20) }}>
                <Icon
                    ...
                    onPress={() => {}}
                />
                <H1 style={{ color: COLOR.BLACK, fontWeight: 'bold', marginLeft: scale(10) }}>Histórico de Alertas</H1>
            </View>
          </ImageBackground>
          <View>
            <Text style={{ paddingLeft: scale(20), paddingBottom: verticalScale(4), color: COLOR.MAIN, fontSize: scale(14) }}>Pesquisar</Text>
